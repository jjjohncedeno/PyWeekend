...
const accountLevelPermissions = generateActionTemplates(
  ...
  [
    ...
    },
    {
      ...
      description: I18n.t(
        'To view the Reports tab, PyWeekend - view usage reports must also be enabled.'
      )
    },
    {
